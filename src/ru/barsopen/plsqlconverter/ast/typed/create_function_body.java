...
public class create_function_body implements create_function_or_procedure_body, _baseNode {
  public int _line = -1;
  public int _col = -1;
...
public void _setLine(int line) { this._line = line; }
  ...
  public java.util.List<_baseNode> _getChildren() {
    ...
    result.addAll(this.invoker_rights_clauses);
    result.addAll(this.parallel_enable_clauses);
    result.addAll(this.result_cache_clauses);
    if (this.function_impl != null) {
      result.add(this.function_impl);
    }
    return result;
  }
