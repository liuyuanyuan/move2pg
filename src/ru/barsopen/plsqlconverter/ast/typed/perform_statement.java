...
public void _setLine(int line) { this._line = line; }
  ...
  public expression_or_sql_statement inner = null;
  public expression_or_sql_statement get_inner() { return this.inner; }
  public void set_inner(expression_or_sql_statement value) {
  ...
  public void _replace(_baseNode child, _baseNode replacement) {
    if (this.inner == child) {
      this.set_inner((ru.barsopen.plsqlconverter.ast.typed.expression_or_sql_statement)replacement);
      return;
    }
