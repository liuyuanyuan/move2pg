...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  org.antlr.runtime.tree.Tree commentsNode = tree.getChild(_i);
  _result.setComments(ru.barsopen.plsqlconverter.util.AttachedComments.fromTree(commentsNode));
  ++_i;
}
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static unit_statement parseunit_statement(org.antlr.runtime.tree.Tree tree) {
    ...
    if (canParsecreate_function_or_procedure_body(tree)) return parsecreate_function_or_procedure_body(tree);
    ...
    if (canParsecreate_view(tree)) return parsecreate_view(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParsecreate_function_or_procedure_body(org.antlr.runtime.tree.Tree tree) {
    return canParsecreate_function_body(tree) || canParsecreate_procedure_body(tree);
  }

  public static create_function_or_procedure_body parsecreate_function_or_procedure_body(org.antlr.runtime.tree.Tree tree) {
    if (!canParsecreate_function_or_procedure_body(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParseobject_type_def(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParseobject_as_or_under_part(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_object_as_or_under_part(parseobject_as_or_under_part(tree.getChild(_i)));
    ++_i;
    ...
    if (_i < tree.getChildCount() && (canParsesqlj_object_type(tree.getChild(_i)))) {
      _result.set_sqlj_object_type(parsesqlj_object_type(tree.getChild(_i)));
      ++_i;
    }

    while (_i < tree.getChildCount() && (canParsemodifier_clause(tree.getChild(_i)))) {
      _result.add_modifier_clauses(parsemodifier_clause(tree.getChild(_i)));
      ++_i;
    }

    if (!(_i < tree.getChildCount() && (canParseobject_type_def_members(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_object_type_def_members(parseobject_type_def_members(tree.getChild(_i)));
    ++_i;
  ...
  public static object_type_def make_object_type_def(ru.barsopen.plsqlconverter.ast.typed.object_as_or_under_part object_as_or_under_part,
      ru.barsopen.plsqlconverter.ast.typed.invoker_rights_clause invoker_rights_clause,
      ru.barsopen.plsqlconverter.ast.typed.sqlj_object_type sqlj_object_type,
      java.util.List<ru.barsopen.plsqlconverter.ast.typed.modifier_clause> modifier_clauses,
      ru.barsopen.plsqlconverter.ast.typed.object_type_def_members object_type_def_members) {
    object_type_def _result = new object_type_def();
    _result.set_object_as_or_under_part(object_as_or_under_part);
    _result.set_invoker_rights_clause(invoker_rights_clause);
    _result.set_sqlj_object_type(sqlj_object_type);
    if (modifier_clauses != null) {
      for (ru.barsopen.plsqlconverter.ast.typed.modifier_clause _value: modifier_clauses) { _result.add_modifier_clauses(_value); }
    }
    _result.set_object_type_def_members(object_type_def_members);
    return _result;
  }

  public static boolean canParseobject_type_def_members(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.OBJECT_MEMBERS;
  }

  public static object_type_def_members parseobject_type_def_members(org.antlr.runtime.tree.Tree tree) {
    if (!canParseobject_type_def_members(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    object_type_def_members _result = new object_type_def_members();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    while (_i < tree.getChildCount() && (canParseelement_spec(tree.getChild(_i)))) {
      _result.add_element_specs(parseelement_spec(tree.getChild(_i)));
      ++_i;
    }
  ...
  public static object_type_def_members make_object_type_def_members(java.util.List<ru.barsopen.plsqlconverter.ast.typed.element_spec> element_specs) {
    object_type_def_members _result = new object_type_def_members();
    if (element_specs != null) {
      for (ru.barsopen.plsqlconverter.ast.typed.element_spec _value: element_specs) { _result.add_element_specs(_value); }
    }
    return _result;
  }

  public static boolean canParseobject_as_or_under_part(org.antlr.runtime.tree.Tree tree) {
    return canParseobject_as_part(tree) || canParseobject_under_part(tree);
  }

  public static object_as_or_under_part parseobject_as_or_under_part(org.antlr.runtime.tree.Tree tree) {
    if (!canParseobject_as_or_under_part(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParseobject_as_part(tree)) return parseobject_as_part(tree);
    if (canParseobject_under_part(tree)) return parseobject_under_part(tree);
    throw new RuntimeException("Tree type mismatch");
  }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParseobject_as_part_def(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_object_as_part_def(parseobject_as_part_def(tree.getChild(_i)));
    ++_i;
  ...
  public static object_as_part make_object_as_part(ru.barsopen.plsqlconverter.ast.typed.object_as_part_def object_as_part_def) {
    object_as_part _result = new object_as_part();
    _result.set_object_as_part_def(object_as_part_def);
    return _result;
  }

  public static boolean canParseobject_as_part_def(org.antlr.runtime.tree.Tree tree) {
    return canParseobject_as_part_def_object(tree) || canParsevarray_type_def(tree) || canParsenested_table_type_def(tree);
  }

  public static object_as_part_def parseobject_as_part_def(org.antlr.runtime.tree.Tree tree) {
    if (!canParseobject_as_part_def(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParseobject_as_part_def_object(tree)) return parseobject_as_part_def_object(tree);
    if (canParsevarray_type_def(tree)) return parsevarray_type_def(tree);
    if (canParsenested_table_type_def(tree)) return parsenested_table_type_def(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParseobject_as_part_def_object(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.OBJECT_VK;
  }

  public static object_as_part_def_object parseobject_as_part_def_object(org.antlr.runtime.tree.Tree tree) {
    if (!canParseobject_as_part_def_object(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    object_as_part_def_object _result = new object_as_part_def_object();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static object_as_part_def_object make_object_as_part_def_object() {
    object_as_part_def_object _result = new object_as_part_def_object();
    return _result;
  }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static object_under_part make_object_under_part(ru.barsopen.plsqlconverter.ast.typed.type_spec type_spec) {
    object_under_part _result = new object_under_part();
    _result.set_type_spec(type_spec);
    return _result;
  }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static nested_table_type_def make_nested_table_type_def(ru.barsopen.plsqlconverter.ast.typed.type_spec type_spec,
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static sqlj_object_type make_sqlj_object_type(ru.barsopen.plsqlconverter.ast.typed.expression expression,
      java.util.List<org.antlr.runtime.tree.Tree> contents) {
    sqlj_object_type _result = new sqlj_object_type();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParsecreate_view(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.CREATE_VIEW;
  }

  public static create_view parsecreate_view(org.antlr.runtime.tree.Tree tree) {
    if (!canParsecreate_view(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    create_view _result = new create_view();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (_i < tree.getChildCount() && (canParsecreate_view_force_clause(tree.getChild(_i)))) {
      _result.set_create_view_force_clause(parsecreate_view_force_clause(tree.getChild(_i)));
      ++_i;
    }

    if (!(_i < tree.getChildCount() && (canParseview_name(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_view_name(parseview_name(tree.getChild(_i)));
    ++_i;

    if (_i < tree.getChildCount() && (canParseview_type_clause(tree.getChild(_i)))) {
      _result.set_view_type_clause(parseview_type_clause(tree.getChild(_i)));
      ++_i;
    }
  ...
  public static create_view make_create_view(org.antlr.runtime.tree.Tree REPLACE_VK,
      ru.barsopen.plsqlconverter.ast.typed.create_view_force_clause create_view_force_clause,
      ru.barsopen.plsqlconverter.ast.typed.view_name view_name,
      ru.barsopen.plsqlconverter.ast.typed.view_type_clause view_type_clause,
    ...
    create_view _result = new create_view();
    _result.set_REPLACE_VK(REPLACE_VK);
    _result.set_create_view_force_clause(create_view_force_clause);
    _result.set_view_name(view_name);
    _result.set_view_type_clause(view_type_clause);
    _result.set_subquery(subquery);
    _result.set_subquery_restriction_clause(subquery_restriction_clause);
    return _result;
  }

  public static boolean canParsecreate_view_force_clause(org.antlr.runtime.tree.Tree tree) {
    return canParsecreate_view_force_clause_noforce(tree) || canParsecreate_view_force_clause_force(tree);
  }

  public static create_view_force_clause parsecreate_view_force_clause(org.antlr.runtime.tree.Tree tree) {
    if (!canParsecreate_view_force_clause(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParsecreate_view_force_clause_noforce(tree)) return parsecreate_view_force_clause_noforce(tree);
    if (canParsecreate_view_force_clause_force(tree)) return parsecreate_view_force_clause_force(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParsecreate_view_force_clause_noforce(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.NOFORCE;
  }

  public static create_view_force_clause_noforce parsecreate_view_force_clause_noforce(org.antlr.runtime.tree.Tree tree) {
    if (!canParsecreate_view_force_clause_noforce(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    create_view_force_clause_noforce _result = new create_view_force_clause_noforce();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static create_view_force_clause_noforce make_create_view_force_clause_noforce() {
    create_view_force_clause_noforce _result = new create_view_force_clause_noforce();
    return _result;
  }

  public static boolean canParsecreate_view_force_clause_force(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.FORCE_VK;
  }

  public static create_view_force_clause_force parsecreate_view_force_clause_force(org.antlr.runtime.tree.Tree tree) {
    if (!canParsecreate_view_force_clause_force(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    create_view_force_clause_force _result = new create_view_force_clause_force();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static create_view_force_clause_force make_create_view_force_clause_force() {
    create_view_force_clause_force _result = new create_view_force_clause_force();
    return _result;
  }

  public static boolean canParseview_type_clause(org.antlr.runtime.tree.Tree tree) {
    return canParseview_type_constraints_clause(tree);
  }

  public static view_type_clause parseview_type_clause(org.antlr.runtime.tree.Tree tree) {
    if (!canParseview_type_clause(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParseview_type_constraints_clause(tree)) return parseview_type_constraints_clause(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParseview_type_constraints_clause(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.VIEW_TYPE_CONSTRAINTS;
  }

  public static view_type_constraints_clause parseview_type_constraints_clause(org.antlr.runtime.tree.Tree tree) {
    if (!canParseview_type_constraints_clause(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    view_type_constraints_clause _result = new view_type_constraints_clause();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParseview_type_constraints_clause_item(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    while (_i < tree.getChildCount() && (canParseview_type_constraints_clause_item(tree.getChild(_i)))) {
      _result.add_items(parseview_type_constraints_clause_item(tree.getChild(_i)));
      ++_i;
    }
  ...
  public static view_type_constraints_clause make_view_type_constraints_clause(java.util.List<ru.barsopen.plsqlconverter.ast.typed.view_type_constraints_clause_item> items) {
    view_type_constraints_clause _result = new view_type_constraints_clause();
    if (items != null) {
      for (ru.barsopen.plsqlconverter.ast.typed.view_type_constraints_clause_item _value: items) { _result.add_items(_value); }
    }
    return _result;
  }

  public static boolean canParseview_type_constraints_clause_item(org.antlr.runtime.tree.Tree tree) {
    return canParseview_type_constraint_item_inline(tree);
  }

  public static view_type_constraints_clause_item parseview_type_constraints_clause_item(org.antlr.runtime.tree.Tree tree) {
    if (!canParseview_type_constraints_clause_item(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParseview_type_constraint_item_inline(tree)) return parseview_type_constraint_item_inline(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParseview_type_constraint_item_inline(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.VIEW_TYPE_CONSTRAINT_ITEM_INLINE;
  }

  public static view_type_constraint_item_inline parseview_type_constraint_item_inline(org.antlr.runtime.tree.Tree tree) {
    if (!canParseview_type_constraint_item_inline(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    view_type_constraint_item_inline _result = new view_type_constraint_item_inline();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static view_type_constraint_item_inline make_view_type_constraint_item_inline(ru.barsopen.plsqlconverter.ast.typed.id id) {
    view_type_constraint_item_inline _result = new view_type_constraint_item_inline();
    _result.set_id(id);
    return _result;
  }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static statement parsestatement(org.antlr.runtime.tree.Tree tree) {
    ...
    if (canParsepgsql_raise_statement(tree)) return parsepgsql_raise_statement(tree);
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParseexpression_or_sql_statement(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_inner(parseexpression_or_sql_statement(tree.getChild(_i)));
    ++_i;
  ...
  public static perform_statement make_perform_statement(ru.barsopen.plsqlconverter.ast.typed.expression_or_sql_statement inner) {
    perform_statement _result = new perform_statement();
    _result.set_inner(inner);
    return _result;
  }

  public static boolean canParseexpression_or_sql_statement(org.antlr.runtime.tree.Tree tree) {
    return canParseexpression(tree) || canParsedata_manipulation_language_statements(tree);
  }

  public static expression_or_sql_statement parseexpression_or_sql_statement(org.antlr.runtime.tree.Tree tree) {
    if (!canParseexpression_or_sql_statement(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParsepgsql_raise_statement(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_RAISE;
  }

  public static pgsql_raise_statement parsepgsql_raise_statement(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_statement(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    pgsql_raise_statement _result = new pgsql_raise_statement();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParsepgsql_raise_level(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_pgsql_raise_level(parsepgsql_raise_level(tree.getChild(_i)));
    ++_i;

    if (!(_i < tree.getChildCount() && (canParseconstant_char_string(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_format(parseconstant_char_string(tree.getChild(_i)));
    ++_i;
    ...
    if (_i < tree.getChildCount() && (canParsepgsql_raise_using_options(tree.getChild(_i)))) {
      _result.set_using(parsepgsql_raise_using_options(tree.getChild(_i)));
      ++_i;
    }
  ...
  public static pgsql_raise_statement make_pgsql_raise_statement(ru.barsopen.plsqlconverter.ast.typed.pgsql_raise_level pgsql_raise_level,
      ru.barsopen.plsqlconverter.ast.typed.constant_char_string format,
      java.util.List<ru.barsopen.plsqlconverter.ast.typed.expression> expressions,
      ru.barsopen.plsqlconverter.ast.typed.pgsql_raise_using_options using) {
    pgsql_raise_statement _result = new pgsql_raise_statement();
    _result.set_pgsql_raise_level(pgsql_raise_level);
    _result.set_format(format);
    if (expressions != null) {
      for (ru.barsopen.plsqlconverter.ast.typed.expression _value: expressions) { _result.add_expressions(_value); }
    }
    _result.set_using(using);
    return _result;
  }

  public static boolean canParsepgsql_raise_using_options(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_USING;
  }

  public static pgsql_raise_using_options parsepgsql_raise_using_options(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_using_options(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    pgsql_raise_using_options _result = new pgsql_raise_using_options();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParsepgsql_raise_using_option(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    while (_i < tree.getChildCount() && (canParsepgsql_raise_using_option(tree.getChild(_i)))) {
      _result.add_options(parsepgsql_raise_using_option(tree.getChild(_i)));
      ++_i;
    }
  ...
  public static pgsql_raise_using_options make_pgsql_raise_using_options(java.util.List<ru.barsopen.plsqlconverter.ast.typed.pgsql_raise_using_option> options) {
    pgsql_raise_using_options _result = new pgsql_raise_using_options();
    if (options != null) {
      for (ru.barsopen.plsqlconverter.ast.typed.pgsql_raise_using_option _value: options) { _result.add_options(_value); }
    }
    return _result;
  }

  public static boolean canParsepgsql_raise_using_option(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_OPTION;
  }

  public static pgsql_raise_using_option parsepgsql_raise_using_option(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_using_option(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    pgsql_raise_using_option _result = new pgsql_raise_using_option();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParsepgsql_raise_using_option_name(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_name(parsepgsql_raise_using_option_name(tree.getChild(_i)));
    ++_i;
  ...
  public static pgsql_raise_using_option make_pgsql_raise_using_option(ru.barsopen.plsqlconverter.ast.typed.pgsql_raise_using_option_name name,
      ru.barsopen.plsqlconverter.ast.typed.expression expression) {
    pgsql_raise_using_option _result = new pgsql_raise_using_option();
  ...
  public static boolean canParsepgsql_raise_using_option_name(org.antlr.runtime.tree.Tree tree) {
    return canParsepgsql_raise_using_option_name_errcode(tree);
  }

  public static pgsql_raise_using_option_name parsepgsql_raise_using_option_name(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_using_option_name(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParsepgsql_raise_using_option_name_errcode(tree)) return parsepgsql_raise_using_option_name_errcode(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParsepgsql_raise_using_option_name_errcode(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_ERRCODE;
  }

  public static pgsql_raise_using_option_name_errcode parsepgsql_raise_using_option_name_errcode(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_using_option_name_errcode(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    pgsql_raise_using_option_name_errcode _result = new pgsql_raise_using_option_name_errcode();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static pgsql_raise_using_option_name_errcode make_pgsql_raise_using_option_name_errcode() {
    pgsql_raise_using_option_name_errcode _result = new pgsql_raise_using_option_name_errcode();
    return _result;
  }

  public static boolean canParsepgsql_raise_level(org.antlr.runtime.tree.Tree tree) {
    return canParsepgsql_raise_level_notice(tree) || canParsepgsql_raise_level_exception(tree);
  }

  public static pgsql_raise_level parsepgsql_raise_level(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_level(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    if (canParsepgsql_raise_level_notice(tree)) return parsepgsql_raise_level_notice(tree);
    if (canParsepgsql_raise_level_exception(tree)) return parsepgsql_raise_level_exception(tree);
    throw new RuntimeException("Tree type mismatch");
  }

  public static boolean canParsepgsql_raise_level_notice(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_NOTICE;
  }

  public static pgsql_raise_level_notice parsepgsql_raise_level_notice(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_level_notice(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    pgsql_raise_level_notice _result = new pgsql_raise_level_notice();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static pgsql_raise_level_notice make_pgsql_raise_level_notice() {
    pgsql_raise_level_notice _result = new pgsql_raise_level_notice();
    return _result;
  }

  public static boolean canParsepgsql_raise_level_exception(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_EXCEPTION;
  }

  public static pgsql_raise_level_exception parsepgsql_raise_level_exception(org.antlr.runtime.tree.Tree tree) {
    if (!canParsepgsql_raise_level_exception(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    pgsql_raise_level_exception _result = new pgsql_raise_level_exception();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static pgsql_raise_level_exception make_pgsql_raise_level_exception() {
    pgsql_raise_level_exception _result = new pgsql_raise_level_exception();
    return _result;
  }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (_i < tree.getChildCount() && (canParsefrom_clause(tree.getChild(_i)))) {
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static expression_element parseexpression_element(org.antlr.runtime.tree.Tree tree) {
    ...
    if (canParseexpression_element_standard_fn(tree)) return parseexpression_element_standard_fn(tree);
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParseexpression_element_standard_fn(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.STANDARD_FUNCTION;
  }

  public static expression_element_standard_fn parseexpression_element_standard_fn(org.antlr.runtime.tree.Tree tree) {
    if (!canParseexpression_element_standard_fn(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    expression_element_standard_fn _result = new expression_element_standard_fn();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static expression_element_standard_fn make_expression_element_standard_fn(ru.barsopen.plsqlconverter.ast.typed.standard_function standard_function) {
    expression_element_standard_fn _result = new expression_element_standard_fn();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParsestandard_function(org.antlr.runtime.tree.Tree tree) {
    return canParsestandard_function_enabling_over(tree) || canParsestandard_function_count(tree) || canParsestandard_function_xmlcast(tree) || canParsestandard_function_cast(tree) || canParsestandard_function_enabling_within_or_over(tree) || canParsestandard_function_extract(tree) || canParsestandard_function_translate(tree) || canParsestandard_function_trim(tree) || canParsestandard_function_xmlagg(tree) || canParsestandard_function_xmlparse(tree) || canParsestandard_function_root(tree) || canParsestandard_function_table(tree) || canParsestandard_function_xmlelement(tree);
  }
  ...
  public static standard_function parsestandard_function(org.antlr.runtime.tree.Tree tree) {
    ...
    if (canParsestandard_function_cast(tree)) return parsestandard_function_cast(tree);
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParsestandard_function_cast(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.CAST_VK;
  }

  public static standard_function_cast parsestandard_function_cast(org.antlr.runtime.tree.Tree tree) {
    if (!canParsestandard_function_cast(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    standard_function_cast _result = new standard_function_cast();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static standard_function_cast make_standard_function_cast(ru.barsopen.plsqlconverter.ast.typed.expression_or_subquery expression_or_subquery,
      ru.barsopen.plsqlconverter.ast.typed.type_spec type_spec) {
    standard_function_cast _result = new standard_function_cast();
    _result.set_expression_or_subquery(expression_or_subquery);
    _result.set_type_spec(type_spec);
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParseview_name(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.VIEW_NAME;
  }

  public static view_name parseview_name(org.antlr.runtime.tree.Tree tree) {
    if (!canParseview_name(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    view_name _result = new view_name();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static view_name make_view_name(java.util.List<ru.barsopen.plsqlconverter.ast.typed.id> ids) {
    view_name _result = new view_name();
    if (ids != null) {
      for (ru.barsopen.plsqlconverter.ast.typed.id _value: ids) { _result.add_ids(_value); }
    }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static constant parseconstant(org.antlr.runtime.tree.Tree tree) {
    ...
    if (canParseconstant_pgsql_typed_literal(tree)) return parseconstant_pgsql_typed_literal(tree);
    throw new RuntimeException("Tree type mismatch");
  }
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  public static boolean canParseconstant_pgsql_typed_literal(org.antlr.runtime.tree.Tree tree) {
    return tree.getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.PGSQL_TYPED_LITERAL;
  }

  public static constant_pgsql_typed_literal parseconstant_pgsql_typed_literal(org.antlr.runtime.tree.Tree tree) {
    if (!canParseconstant_pgsql_typed_literal(tree)) {
      throw new RuntimeException("Tree type mismatch");
    }

    constant_pgsql_typed_literal _result = new constant_pgsql_typed_literal();
...
if (_i < tree.getChildCount() && tree.getChild(_i).getType() == ru.barsopen.plsqlconverter.PLSQLPrinter.COMMENT) {
  ...
  ++_i;
    ...
    if (!(_i < tree.getChildCount() && (canParseconstant_char_string(tree.getChild(_i))))) { throw new RuntimeException("Tree type mismatch"); }
    _result.set_constant_char_string(parseconstant_char_string(tree.getChild(_i)));
    ++_i;
  ...
  public static constant_pgsql_typed_literal make_constant_pgsql_typed_literal(ru.barsopen.plsqlconverter.ast.typed.type_spec type_spec,
      ru.barsopen.plsqlconverter.ast.typed.constant_char_string constant_char_string) {
    constant_pgsql_typed_literal _result = new constant_pgsql_typed_literal();
    _result.set_type_spec(type_spec);
    _result.set_constant_char_string(constant_char_string);
    return _result;
  }
